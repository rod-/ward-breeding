...
#name=c("shirokin","dracozen","rogermartin","firestorm","pmoney","bigkeeper","ajb39","athenakitty","whitewalker","shaun99","azabech","vandor","feet","grggge","ozwold","ayleth","unlimitless","ellusias","mayahem6969","yubbaman","sirbanayners","squizzle","chungi82","avatarroku","sladesalvatore","brewdoctor","vanation","tellerin","juanmaster","tontojohn","poipoi","buggsie","zyphon","nevyn","rodminus","austre","pull","ragar2015","amarok","fatboo")