...
rosterb <- c("ynci", "rodminus", "chungi82", "fatboo", "primaites", "zyphon", "acesoh", "lususnaturae", "nevyn", "strwberrypizza", "jutt2222", "zhenx", "rodplus", "moonspawn", "bigkeeper", "egonzo", "icehyunkel", 
    "drizztray", "lastat", "amarok", "vanation", "chillipeppers", "princessjulie", "nickademus", "dracaryx", "brewdoctor", "tellerin", "snoopchic", "aragornblaze", "poipoi", "drizztlee", "meningi", "wingslayer", 
    "chuckdu", "dogecoin", "unlimitless", "insatiable", "queenapps", "thegudge", "phantasy", "rogermartin", "baeel", "juanmaster", "colonelxchilli", "bigreddog", "evanard", "denmiz", "mcs117", "henryv", "colonelchilli")
...
rosterb <- c("ynci", "rodminus", "primaites", "zyphon", "moonspawn", "acesoh", "chungi82", "fatboo", "ironduke", "igrimreaper", "thewash", "nevyn", "drizztray", "amarok", "zhenx", "egonzo", "strwberrypizza", "alfalfa", 
    "rodplus", "icehyunkel", "bigkeeper", "drizztlee", "lastat", "avatarroku", "fival", "poipoi", "nickademus", "insatiable", "snoopchic", "aragornblaze", "dracaryx", "brewdoctor", "princessjulie", "traceyv2", "arodriguez", 
    "lati", "wingslayer", "meningi", "thegudge", "tellerin", "unlimitless", "juanmaster", "bigreddog", "tasha", "dogecoin", "sparklefishh", "smokeyou", "xsilverstormx", "xxweathersxx")
# keeps the roster up to date.
rosterb[rosterb == "brewdoctor"] <- "littlemoonwash"
rosterb[rosterb == "meningi"]<- "mythlar"
rosterb[rosterb == "thewash"]<-"bigbossman"
rosterb[rosterb=="icehyunkel"]<-"brewdoctor"
rosterb[rosterb=="fival"]<-"thenexten"
rosterb[rosterb=="tellerin"]<-"colonelxchilli"
...
warcheck <- function(war, roster = rosterb) {
    return(c(roster[!roster %in% war], war[!war %in% roster]))
}
...
# 'warunid2')
wardf <- list(war1, war2, war3, war4, war5, war6, war7, war8, war9, war10, war11, war12, wardmata, warberserkers, wargstorm, warsbears, wartoo, wardmata2, warmystix, wareldest, wardmata3, wareldest2, warsbears2, 
    waruntouch, warhounds, warundawn, warsurfer, wareverest, wardravengers, wartides, warmongers, warforder, wartbdragons, wardmata4, adminresponse, waruntouch2, warfear, warsbears4, warfear2, warbears5, wardevils, 
    warhounds2, warnd, warfa, warfa2, warsbears6, warundrag, warunid, warsbears7, warvortex, warrr, warunid2, wartherage, wardevils3, warnd2)
